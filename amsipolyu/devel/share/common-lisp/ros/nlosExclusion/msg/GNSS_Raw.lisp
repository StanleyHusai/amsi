...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GNSS_Raw>)))
  ...
  (cl:format cl:nil "float64 GNSS_time~%float64 total_sv~%float64 prn_satellites_index~%float64 pseudorange~%float64 snr~%float64 elevation~%float64 azimuth~%float64 err_tropo~%float64 err_iono~%float64 sat_clk_err~%float64 sat_pos_x~%float64 sat_pos_y~%float64 sat_pos_z~%#float64 GNSSCovariance~%int64 visable #0-Not sure 1-visable 2-invisable~%string  sat_system~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GNSS_Raw)))
  "Returns full string definition for message of type 'GNSS_Raw"
  (cl:format cl:nil "float64 GNSS_time~%float64 total_sv~%float64 prn_satellites_index~%float64 pseudorange~%float64 snr~%float64 elevation~%float64 azimuth~%float64 err_tropo~%float64 err_iono~%float64 sat_clk_err~%float64 sat_pos_x~%float64 sat_pos_y~%float64 sat_pos_z~%#float64 GNSSCovariance~%int64 visable #0-Not sure 1-visable 2-invisable~%string  sat_system~%~%~%"))
